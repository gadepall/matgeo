...
\end{multicols}
\hfill (2023) 
\item Let $C_1$ be the circle of radius 1 with center at the origin. Let $C_2$ be the circle of radius $r$ with center at the point $\vec{A} = (4,1)$, where $1 < r < 3$. Two distinct common tangents $PQ$ and $ST$ of $C_1$ and $C_2$ are drawn. The tangent $PQ$ touches $C_1$ at $\vec{P}$ and $C_2$ at $\vec{Q}$. The tangent $ST$ touches $C_1$ at $\vec{S}$ and $C_2$ at $\vec{T}$. Midpoints of the line segments $PQ$ and $ST$ are joined to form a line which meets the $X$ axis at a point $\vec{B}$. If $AB = \sqrt{5}$, then the value of $r^2$ is
\rule{1cm}{0.1pt}.
\hfill (2023)
\item Consider the ellipse $$ \frac{x^2}{9} + \frac{y^2}{4} = 1.$$ Let $ \vec{S}\brak{p, q} $ be a point in the first quadrant such that 
    \[
    \frac{p^2}{9} + \frac{q^2}{4} > 1.
    \]
    Two tangents are drawn from $ \vec{S} $ to the ellipse, of which one meets the ellipse at one end point of the minor axis and the other meets the ellipse at a point $ \vec{T} $ in the fourth quadrant. Let $ \vec{R} $ be the vertex of the ellipse with positive $ x $-coordinate and $ \vec{O} $ be the center of the ellipse. If the area of the triangle $ \triangle ORT $ is $ \frac{3}{2} $, then which of the following options is correct?
\hfill (2024)
    \begin{multicols}{4}
\begin{enumerate}
\item $ q = 2, p = 3\sqrt{3} $
...
\item $ q = 1, p = 6\sqrt{3} $
    \end{enumerate}
\end{multicols}
\item Let the straight line $y = 2x$ touch a circle with center $\brak{0, a}$, $a > 0$, and radius $r$ at a point $\vec{A}_1$.
Let $\vec{B}_1$ be the point on the circle such that the line segment $\vec{A}_1\vec{B}_1$ is a diameter of the circle. Let $a + r = 5 + \sqrt{5}$.
Match the following
\begin{multicols}{2}
	\begin{enumerate}[label=(\Alph*)]
	\item  $a$ equals 	    
	\item  $r$ equals         
	\item  $\vec{A}_1$ equals 
	\item  $\vec{B}_1$ equals 
\end{enumerate}
\columnbreak
...
The correct option is
    \hfill (2024)
\begin{enumerate}
\item $ \brak{A} \rightarrow \brak{4} \quad \brak{B} \rightarrow \brak{2} \quad \brak{C} \rightarrow \brak{1} \quad \brak{D} \rightarrow \brak{3} $
\item $ \brak{A} \rightarrow \brak{2} \quad \brak{B} \rightarrow \brak{4} \quad \brak{C} \rightarrow \brak{1} \quad \brak{D} \rightarrow \brak{3} $
\item $ \brak{A} \rightarrow \brak{4} \quad \brak{B} \rightarrow \brak{2} \quad \brak{C} \rightarrow \brak{5} \quad \brak{D} \rightarrow \brak{3} $
\item $ \brak{A} \rightarrow \brak{2} \quad \brak{B} \rightarrow \brak{4} \quad \brak{C} \rightarrow \brak{3} \quad \brak{D} \rightarrow \brak{5} $
\end{enumerate}
\end{enumerate}
